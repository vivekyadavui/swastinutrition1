...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $page['meta_title'] = trim((string) ($_POST['meta_title'] ?? ''));
    $page['meta_description'] = trim((string) ($_POST['meta_description'] ?? ''));
    ...
    $slugCheck = db()->prepare('SELECT id FROM pages WHERE slug = :slug AND id != :id LIMIT 1');
    $slugCheck->execute(['slug' => $page['slug'], 'id' => $id]);
    if ($slugCheck->fetch()) {
        ...
        if ($id > 0) {
            $stmt = db()->prepare(
                'UPDATE pages SET title = :title, slug = :slug, meta_title = :meta_title,
                 meta_description = :meta_description, content = :content, status = :status WHERE id = :id'
            );
            $stmt->execute([
                'title' => $page['title'],
                'slug' => $page['slug'],
            ...
            $stmt = db()->prepare(
                'INSERT INTO pages (title, slug, meta_title, meta_description, content, status)
                 VALUES (:title, :slug, :meta_title, :meta_description, :content, :status)'
            );
            $stmt->execute([
                'title' => $page['title'],
                'slug' => $page['slug'],
            ...
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0">
                <div class="d-flex align-items-center profile-media"><img class="b-r-25" src="../assets/images/dashboard/profile.png" alt="">
                  <div class="flex-grow-1 user"><span><?php echo e($user['name'] ?? 'Admin'); ?></span>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="pages.php">
                      <svg class="stroke-icon">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h4><?php echo $id > 0 ? 'Edit Page' : 'Create Page'; ?></h4>
                    <p class="f-m-light mt-1">Manage page content and SEO metadata using the fields below.</p>
                  </div>
                  <div class="card-body">
                    <?php if ($errors): ?>
                    ...
                    <?php endif; ?>
                    <form class="row g-3" method="post" action="page-edit.php<?php echo $id > 0 ? '?id=' . (int) $id : ''; ?>">
                      <input type="hidden" name="csrf_token" value="<?php echo e(csrf_token()); ?>">
                      <div class="col-md-6">
                        <label class="form-label" for="page-title">Title</label>
                        <input class="form-control" id="page-title" type="text" name="title" value="<?php echo e($page['title']); ?>" required="">
                      </div>
                      <div class="col-md-6">
                        <label class="form-label" for="page-slug">Slug</label>
                        <input class="form-control" id="page-slug" type="text" name="slug" value="<?php echo e($page['slug']); ?>" placeholder="about-us">
                      </div>
                      <div class="col-md-6">
                        <label class="form-label" for="page-meta-title">Meta Title</label>
                        <input class="form-control" id="page-meta-title" type="text" name="meta_title" value="<?php echo e($page['meta_title']); ?>">
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-12">
                        <label class="form-label" for="page-meta-description">Meta Description</label>
                        <textarea class="form-control" id="page-meta-description" name="meta_description" rows="2"><?php echo e($page['meta_description']); ?></textarea>
                      </div>
                      <div class="col-12">
                        <label class="form-label" for="page-content">Content</label>
                        <textarea class="form-control" id="page-content" name="content" rows="8"><?php echo e($page['content']); ?></textarea>
                      </div>
                      <div class="col-12">
