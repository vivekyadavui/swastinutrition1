...
$stmt = db()->query('SELECT id, title, slug, status, updated_at FROM pages ORDER BY updated_at DESC');
$pages = $stmt->fetchAll();
          ...
          <div class="container-fluid basic_table">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header d-flex align-items-center justify-content-between">
                    <div>
                      <h4>Pages</h4><span>Manage website pages and SEO metadata.</span>
                    </div><a class="btn btn-primary" href="page-edit.php">Add Page</a>
                  </div>
                  <div class="table-responsive custom-scrollbar">
                    <table class="table">
                      ...
                      <tbody>
                        <?php if (!$pages): ?>
                          <tr>
                            <td colspan="6">No pages found. Create your first page.</td>
                          </tr>
                        <?php else: ?>
                          <?php foreach ($pages as $page): ?>
                            <tr class="border-bottom-secondary">
                              <th scope="row"><?php echo (int) $page['id']; ?></th>
                              ...
                              <td>
                                <a class="btn btn-sm btn-primary" href="page-edit.php?id=<?php echo (int) $page['id']; ?>">Edit</a>
                                <a class="btn btn-sm btn-outline-danger" href="page-delete.php?id=<?php echo (int) $page['id']; ?>&amp;token=<?php echo e(csrf_token()); ?>" onclick="return confirm('Delete this page?');">Delete</a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
                ...
                <div class="card">
                  ...
                  <div class="card-block row">
                    <div class="col-sm-12 col-lg-12 col-xl-12">
                      <div class="table-responsive custom-scrollbar">
                        <table class="table"> 
                          <caption class="m-2">List of users</caption>
                          <thead>
                            <tr>
                              <th scope="col">Id</th>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Breckpoint Specific</h4><span>Use  <code>.table-responsive.custom-scrollbar"❴-sm|-md|-lg|-xl|-xxl❵"</code> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.</span>
                  </div>
                  <div class="card-block row">
                    <div class="col-sm-12 col-lg-12 col-xl-12">
                      <div class="table-responsive custom-scrollbar">
                        <table class="table table-responsive custom-scrollbar-sm">
                          <thead>
                            <tr>
                              <th scope="col">Id</th>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Responsive Tables With Light Background</h4><span>A <code>.table-responsive.custom-scrollbar ,.light-card</code> inside table element.</span>
                  </div>
                  <div class="card-block row">
                    <div class="col-sm-12 col-lg-12 col-xl-12">
                      <div class="table-responsive custom-scrollbar">
